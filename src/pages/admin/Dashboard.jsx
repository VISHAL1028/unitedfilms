...
const MODULES = [
  {
    ...
    desc: "Add, edit, delete and manage the featured rental equipment on the homepage.",
  ...
  },
  {
    ...
    iconColor: "#c084fc",
    title: "Our Work",
    desc: "Manage portfolio projects shown on the public Our Work page. Add videos, thumbnails, and project details.",
  ...
  },
  {
    ...
    iconColor: "#38bdf8",
    title: "Contact Inbox",
    desc: "Review and manage messages submitted through the website contact form.",
...
const STATS = [
  { label: "Active Modules", value: "3", iconBg: "rgba(245,158,11,0.1)", iconColor: "#f59e0b", Icon: Database },
